...
let profile = {
    name: "Hannah Mosier",
    photo: "hannah-profile.jpg",
    favoriteFoods: [
        "morel mushrooms", "gluten free pizza", "strawberries", "spinach", "nachos"
    ],
    hobbies: [
        "playing the piano", "reading", "gardening"
    ],
    placesLived: []
};
...
photo.setAttribute("alt", `Profile picture of ${profile.photo}`);
